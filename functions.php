...
function wander_setup() {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'wander' ),
	) );
...
function wander_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'wander' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'wander' ),
...
function wander_scripts() {
	...
	wp_enqueue_script( 'wander-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'wander-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
